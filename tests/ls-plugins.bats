...
@test "ls-plugins: list enabled plugins" {
    ...
    assert_equal "julia"            "${lines[7]}"
    assert_equal "node"             "${lines[8]}"
    assert_equal "node-prebuilt"    "${lines[9]}"
    assert_equal "php"              "${lines[10]}"
    assert_equal "python"           "${lines[11]}"
    assert_equal "rust"             "${lines[12]}"
    assert_equal "rust-prebuilt"    "${lines[13]}"
    assert_equal "scala"            "${lines[14]}"
